...
static const DialogueEntryTwoSide aPoSDialogues[] =
{
    ...
    {SAY_INTRO_3_TYRANNUS, NPC_TYRANNUS_INTRO, 0, 0,    13000},
    ...
    {SAY_OUTRO_TYRANNUS_1_SLAVE, NPC_MARTIN_VICTUS_END, SAY_OUTRO_TYRANNUS_1_SLAVE, NPC_GORKUN_IRONSKULL_END, 18000},
    {SAY_OUTRO_TYRANNUS_2_SLAVE, NPC_MARTIN_VICTUS_END, SAY_OUTRO_TYRANNUS_2_SLAVE, NPC_GORKUN_IRONSKULL_END, 13000},
    ...
    switch (iEntry)
    {
        ...
        case SAY_GAUNTLET_PREFIGHT_2:
        {
            if (Creature* pTyrannus = GetSingleCreatureFromStorage(NPC_TYRANNUS))
            {
                ...
                pTyrannus->GetMotionMaster()->MoveFall(); // should do automatic

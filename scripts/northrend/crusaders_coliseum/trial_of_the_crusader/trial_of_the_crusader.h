...
enum
{
    ...
    EVENT_FACTION_CHAMPIONS_ATTACK = 10,
    EVENT_SUMMON_TWINS          = 11,
    EVENT_MAKE_TWINS_ATTACKABLE = 12,
    EVENT_TWINS_KILLED          = 13,
    EVENT_ARTHAS_PORTAL         = 14,
    EVENT_SUMMON_THE_LICHKING   = 15,
    EVENT_DESTROY_FLOOR         = 16,

    FACTION_CHAMPIONS_HEALER_AMOUNT_10  = 2,
    FACTION_CHAMPIONS_HEALER_AMOUNT_25  = 3,
    FACTION_CHAMPIONS_MELEE_DD_AMOUNT_10= 2,
    FACTION_CHAMPIONS_MELEE_DD_AMOUNT_25= 3,

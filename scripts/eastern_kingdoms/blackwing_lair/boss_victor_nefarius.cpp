...
{
    {-7599.32f, -1191.72f, 475.545f, 0.0f},                       // opening where red/blue/black darknid spawner appear (ori 3.05433)
    {-7526.27f, -1135.04f, 473.445f, 0.0f},                       // same as above, closest to door (ori 5.75959)
    {-7498.177f, -1273.277f, 481.649f, 0.0f},                     // nefarian spawn location (ori 1.798)
    {-7502.002f, -1256.503f, 476.758f, 0.0f},                     // nefarian fly to this position
};
